...
from .hydra_repformers import (
    DescrptBlockHydraRepformers,
)
...
@BaseDescriptor.register("hydradpa2")
class DescrptHydraDPA2(BaseDescriptor, torch.nn.Module):
    def __init__(
        self,
        ntypes: int,
        # args for repinit
        ...
        self.repformers = DescrptBlockHydraRepformers(
    ...
    @classmethod
    def deserialize(cls, data: dict) -> "DescrptHydraDPA2":
        data = data.copy()
