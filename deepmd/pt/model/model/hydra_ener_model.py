...
from deepmd.pt.model.atomic_model.energy_hydra_atomic_model import (
    EnergyHydraAtomicModel,
)
...
DPEnergyModel_ = make_model(EnergyHydraAtomicModel)


@BaseModel.register("hydra")
class HydraEnergyModel(DPModelCommon, DPEnergyModel_):
    model_type = "hydra"
